...
class SmaCross(bt.SignalStrategy):
    ...
    def next(self):
        print(self.datas[0].datetime.date(0), self.datas[0].close[0])
        ...
        #     if self.dataclose[-1] > max(self.dataclose[-20:-1]):
        #         self.buy()

        # elif self.dataclose[-1] < min(self.dataclose[-10:-1]):
        #     self.close()
